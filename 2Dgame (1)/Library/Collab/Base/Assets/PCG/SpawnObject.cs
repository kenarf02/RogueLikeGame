...
public class SpawnObject : MonoBehaviour
{
    ...
    {/*
        ...
        */
        if (Physics2D.Raycast(transform.position + transform.up * 0.55f, Vector2.up, 0.5f))
        {
            // DRAW RAY
        ...
        if (Physics2D.Raycast(transform.position - transform.up * 0.55f, Vector2.down, 0.5f))
        {
            downB = true;
        ...
        if (Physics2D.Raycast(transform.position - transform.right * 0.55f, Vector2.left, 0.5f))
        {
            leftB = true;
        ...
        if (Physics2D.Raycast(transform.position + transform.right * 0.55f, Vector2.right, 0.5f))
        {
            rightB = true;
